...
## Recent Changes
- 2026-02-20: Added Power BI embedding feature - Settings > Power BI tab for managing embed URLs (CRUD), reports display as responsive iframes on home page below the header
